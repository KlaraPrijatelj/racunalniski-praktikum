...
% Besede `\texttt{bool}`, `\texttt{true}`, `\texttt{false}` v spodnjem odstavku naj bodo napisane v pisavi 
% za izvorno kodo.
...
kakovost urnika:
\[
k_1 \cdot u_1 + k_2 \cdot u_2 + \text{\dots} + k_{n-1} \cdot u_{n-1} + k_n \cdot u_n
\]
